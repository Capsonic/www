...
namespace Reusable
{
    public interface IReadOnlyRepository<T> where T : class
    {
        ...
        IList<T> GetListByParent<P>(int parentID, string customProperty) where P : class;
    ...
    public class ReadOnlyRepository<T> : IReadOnlyRepository<T> where T : class
    {
        ...
        public IList<T> GetListByParent<P>(int parentID, string customProperty) where P : class
        {
            List<T> list = new List<T>();
            ...
            list = context.Entry(parent).Collection<T>(customProperty)
                .Query()
                .AsNoTracking()
                .ToList();
