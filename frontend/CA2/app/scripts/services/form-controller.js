...
/**
 * @ngdoc service
 * @name ca2App.baseControllers
 * @description
 * # baseControllers
 * Service in the ca2App.
 */
angular.module('ca2App').factory('formController', function($log, $routeParams, validatorService, appConfig, $timeout, $rootScope, $q, $activityIndicator) {
    ...
    return function(oMainConfig) {
        ...
        formCtrl.load = function(oEntityOrID) {
            ...
            return _baseService.loadDependencies()
                .then(function(data) {
                    _fillCatalogs();
        ...
        var _refreshForm = function(oEntityOrID) {
            ...
            //Create
            if (!oEntityOrID) {
                return _baseService.createEntity().then(function(oNewEntity) {
                    scope.baseEntity = angular.copy(oNewEntity);
