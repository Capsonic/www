...
/**
 * @ngdoc service
 * @name ca2App.authService
 * @description
 * # authService
 * Factory in the ca2App.
 */
angular.module('ca2App').factory('authService', function($http, $q, localStorageService, appConfig, userService, $rootScope, $location) {
